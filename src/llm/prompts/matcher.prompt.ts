/**
 * llm/prompts/matcher.prompt.ts
 * MatcherAgent가 사용하는 프롬프트 템플릿.
 * AI는 실제 담당자를 고르지 않고, subTask별 필요 역할(role)을 추천한다.
...
[역할 정의]
- planner  : 기획/정책/요구사항/기능 정의/화면 리스트/IA/범위 정리
- designer : 화면/UI/UX/디자인/와이어프레임/피그마/인터랙션/플로우
- frontend : 프론트 구현/React/Vue/컴포넌트/페이지/상태관리
- backend  : API/DB/서버/인증/비즈니스 로직/배포/인프라
- qa       : 테스트/검증/시나리오/QA/품질/회귀
